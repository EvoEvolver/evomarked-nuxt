<template>
    <div style="width:90%;margin:auto;" v-if="pageEnv.creditInfo.length > 0">
        <h1>Credit Information</h1>
        <p>This page includes the content from the following sources. The contents are copied from their original source and then modified to suit this page.</p>
